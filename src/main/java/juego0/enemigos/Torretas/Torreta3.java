...
public class Torreta3 extends Torreta {

    Map<Integer, Integer> tablaHashX = new HashMap<>();
    Map<Integer, Integer> tablaHashY = new HashMap<>();

    public Torreta3(double positionX, double positionY, int tiempoRecarga) {
        super("images/1984/Jefes/Yamato/T3180.png", positionX, positionY);
        ...
        tablaHashY.put(90, Integer.valueOf(2));
        ...
        tablaHashY.put(270, Integer.valueOf(3));
    ...
    public void update(double p38x, double p38y) {
        ...
        if (paso % 3 == 0) {
            ...
            int angulo = obtenerAnguloNotableCercano(grados);
            if (ultimoGrado != angulo) {
                ultimoGrado = angulo;
                this.setImagen("images/1984/Jefes/Yamato/T3" + Integer.toString(ultimoGrado) + ".png");
