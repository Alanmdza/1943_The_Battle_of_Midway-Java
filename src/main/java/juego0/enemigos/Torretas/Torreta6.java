...
public class Torreta6 extends Torreta {

    Map<Integer, Integer> tablaHashX = new HashMap<>();
    Map<Integer, Integer> tablaHashY = new HashMap<>();

    public Torreta6(double positionX, double positionY, int tiempoRecarga) {
        super("images/1984/Jefes/Tone/T6180.png", positionX, positionY);
    ...
    public void update(double p38x, double p38y) {
        ...
        if (paso % 3 == 0) {
            ...
            if (ultimoGrado != angulo) {
                ultimoGrado = angulo;
                this.setImagen("images/1984/Jefes/Tone/T6" + Integer.toString(ultimoGrado) + ".png");
